    ...
    <div className="min-h-screen flex bg-orange-50">
        ...
        <div className="relative space-y-8">
          <div>
            <h2 className="text-white text-[2.6rem] font-bold leading-tight">
              Начни кулинарное<br />путешествие сегодня
            </h2>
            <p className="mt-4 text-orange-100 text-base leading-relaxed">
              Присоединяйся к тысячам любителей еды, которые сохраняют, делятся и открывают рецепты каждый день.
            </p>
          </div>
          ...
          <ul className="space-y-3">
            {([
              ...
              ['🌍', 'Делись рецептами с мировым сообществом'],
              ['🏷️', 'Тегируй, фильтруй и организуй легко'],
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-[400px]">
          ...
          <h1 className="text-[1.75rem] font-bold text-gray-900 leading-tight">Создайте аккаунт</h1>
          <p className="mt-1 text-gray-400 text-sm mb-8">Зарегистрируйтесь, чтобы сохранять рецепты</p>
